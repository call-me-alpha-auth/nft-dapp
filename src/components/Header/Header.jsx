        ...
        <header id="header_main" className="header_1 js-header">
            ...
            <div className="mode_switcher">
                ...
                <a
                    role="button"
                    onClick={setLight}
                    className={`light d-flex align-items-center ${themeState !== 'dark' ? 'is_active' : ''}`}
                >
                ...
                <a
                    role="button"
                    onClick={setDark}
                    className={`dark d-flex align-items-center ${themeState === 'dark' ? 'is_active' : ''}`}
                >
                    <span className="dark-icon">🌜</span>
                </a>
            </div>
